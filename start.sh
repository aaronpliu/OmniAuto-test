...
show_help() {
    ...
    echo "    ./start.sh test:android tests/mobile/login.spec.ts tests/mobile/other.spec.ts"
    echo ""
    echo -e "  ${YELLOW}指定目录 / Specific directory:${NC}"
    echo "    ./start.sh test:android tests/mobile"
    echo "    ./start.sh test:android tests/mobile/TestGround   (子目录)"
    echo ""
    ...
    echo "  ./start.sh test:android tests/mobile --recording"
